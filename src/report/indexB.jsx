  ...
  return (
    <Page>
      {data.recommendation ? (
        <RecommendationPanel>
          ...
          <div style={{ fontSize: typography.sizes.medium, color: 'var(--core-color-text-primary)', lineHeight: 1.5, marginTop: 6 }}>
            <span style={{ fontWeight: typography.weights.bold }}>{data.recommendation.verdict}.</span>{' '}
      ...
      <Card style={{ overflow: 'visible' }}>
        ...
        <SummaryText style={{ paddingTop: 6, whiteSpace: 'pre-line', paddingBottom: sections.length ? 18 : undefined }}>
          {Array.isArray(data.summary)
            ? data.summary.map((part, i) =>
                typeof part === 'string' ? (
