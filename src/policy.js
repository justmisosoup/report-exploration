...
export const POLICY = [
  ...
  { id:'network', name:'Is it connected to other risky businesses?',
    ...
    {t:'Who actually owns this — the full beneficial ownership structure, not just the named applicant?', a:'Incomplete — undisclosed control', tone:'high',
    ...
    {t:"What's the risk level of each related entity, not just the one in front of you?", a:'1 elevated · 1 watch', tone:'watch',
      ...
      insight:'One connected entity three hops out carries elevated fraud/adverse risk; a second sits on watch. Risk travels through the ownership edge into Vela.', ev:['Network'], asOf:'04.21.26', history:[
        {date:'03.12.19', a:'None connected', tone:'clear', insight:'No controlling network at onboarding — a single natural-person owner.'},
      ]},
    {t:'Have any of those connected businesses been terminated, suspended, or flagged elsewhere?', a:'1 material flag', tone:'high',
    ...
    {t:'Do patterns such as shell structures, layered ownership, or shared virtual addresses suggest deliberate concealment?', a:'Some signals', tone:'watch',
      attrs:[{k:'Layered ownership',v:'3 hops'},{k:'Shared address',v:'Commercial (not virtual)'},{k:'Virtual / CMRA',v:'No'}],
      insight:'Layered ownership adds hops between Vela and the risky entity, but the shared addresses are physical commercial space — a partial concealment signal, not a clean shell pattern.', ev:['Network','Maps'], asOf:'04.21.26', history:[
        {date:'03.12.19', a:'None', tone:'clear', insight:'Flat, single-owner structure with a dedicated address — no concealment signals.'},
      ]},
    {t:'Are there secured-debt or creditor relationships (UCC filings) that tie entities together?', a:'Shared secured party', tone:'watch',
      ...
      insight:'Vela and a connected entity both list the same private secured party. A shared private lender is a stronger link than a large traditional lender would be.', ev:['UCC'], asOf:'08.22.25', history:[
        {date:'03.12.19', a:'None', tone:'clear', insight:'No secured financing statements on file — no creditor ties.'},
      ]},
  ...
  { id:'reputation', name:'What do reputation signals reveal?',
    ...
    {t:'Any bankruptcy filings, and how recent and relevant are they?', a:'None on Vela', tone:'clear',
      ...
      insight:'No bankruptcy filings for Vela. A connected, now-dissolved entity has a historical filing — surfaced through the network, not against Vela itself.', ev:['PACER','Network']},
