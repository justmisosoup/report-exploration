...
export function reportDataFromBusiness(record, nav = {}) {
  ...
  const summary = 'Kairos Physio is a legitimate, operating physical therapy practice with clean fraud signals.'
  ...
  const sections = [
    {
      insight:
        'The business holds a strong rating across 20 reviews on a major mapping platform, with consistent positive patient feedback naming the treating doctor by name.',
      cards: ['reputation'],
    },
    {
      insight:
        'The website is active, professionally built, and describes a specific concierge physical therapy practice at 801 Madison Avenue, New York, NY 10065.',
      cards: ['web', 'verification'],
    },
    {
      insight:
    ...
    },
    {
      ...
      // Marked because the industry classification beneath it is flagged
      // high risk.
      flag: 'warning',
      cards: ['industry'],
    },
